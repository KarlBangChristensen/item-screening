...
step4.mc <- step4_structure_screen(cc.data, i.list, exo.list,
                                p_value_method = "monte_carlo")
print(step4.mc)
# step4.as <- step4_structure_screen(cc.data, i.list, exo.list,
#                                 p_value_method = "asymptotic")
# print(step4.as)
# step4.c.as <- step4_structure_screen(cc.data, i.list, exo.list,
...
##### ** Step 6: tests of global Markov properties of the GLLRM ** #####
step6 <- step6_check_gllrm(cc.data, step5, p_value_method = "asymptotic")
print(step6$moralized_graph)
print(step6$moralized_graph$edges)
print(step6$dif_tests)
print(step6$ld_tests)
