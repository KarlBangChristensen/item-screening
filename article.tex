...
\[
SOURCE(Y_1)=\{X_1,X_2\}, \qquad SOURCE(Y_3)=\{X_1\}, \qquad SOURCE(Y_5)=\{X_2\},
\]
and
\[
DIF(X_1)=\{Y_1,Y_3\}, \qquad DIF(X_2)=\{Y_1,Y_5\}.
\]
...
\hline
$Y_1$ & $X_1$ & $Y_1 \perp X_1 \mid S, X_2$ & $0.06$ & Retain & 1\\
$Y_1$ & $X_2$ & $Y_1 \perp X_2 \mid S,X_1$ & $0.210$ & Remove & 1\\
$Y_1$ & $X_1$ & $Y_1 \perp X_1 \mid S$ & $0.004$ & Retain & 2\\
$Y_3$ & $X_1$ & $Y_3 \perp X_1 \mid S$ & $0.018$ & Retain & 1\\
$Y_5$ & $X_2$ & $Y_5 \perp X_2 \mid S$ & $0.001$ & Retain & 1\\
\hline
\end{tabular}
...
\[
SOURCE^{(3b)}(Y_1)=\{X_1\}, \quad
SOURCE^{(3b)}(Y_3)=\{X_1\}, \quad
SOURCE^{(3b)}(Y_5)=\{X_2\}.
\]
...
\hline
$X_1$ & $Y_1$ & $Y_1 \perp X_1 \mid S,Y_3$ & $0.09$ & Retain & 1\\
$X_1$ & $Y_3$ & $Y_3 \perp X_1 \mid S,Y_1$ & $0.160$ & Remove & 1 \\
$X_1$ & $Y_1$ & $Y_1 \perp X_1 \mid S$ & $0.004$ & Retain & 2\\
$X_2$ & $Y_5$ & $Y_5 \perp X_2 \mid S,Y_1$ & $0.2$ & Retain & 1 \\
$X_2$ & $Y_1$ & $Y_1 \perp X_2 \mid S,Y_5$ & $0.280$ & Remove & 1\\
$X_2$ & $Y_5$ & $Y_5 \perp X_2 \mid S$ & $0.001$ & Retain & 2\\
\hline
\end{tabular}
