...
\subsection*{Monte Carlo Approximation of Conditional Independence Tests}
Algorithms~\ref{alg:step3b} and \ref{alg:step4} both rely on the following Monte Carlo test of conditional independence, which is also used directly in Step 3(c).
